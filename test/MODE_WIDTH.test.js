...
import { EVENT_NAME, ORGANIZER, EVENT_DATA, TIMEKEEPER } from "./utils/MODE_WIDTH_DATA";
...
describe("Test MODE_WIDTH", () => {
  ...
  it("Create MODE_WIDTH_Event", async () => {
  ...
  it("Create MODE_WIDTH_Event_TimeKeeper", async () => {
